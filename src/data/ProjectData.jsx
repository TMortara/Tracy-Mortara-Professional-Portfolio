...
export const ProjectData = [
  ...
  // },
  {
    ...
    description:
      "Weather application that allows users to see the current and 5 day forecast for a selected city.",
  ...
  },
  {
    ...
    tags: ["JavaScript", "CSS", "HTML"],
    description:
      "Basic coding quiz that allows users to test their JavaScript knowledge.",
